...
@section('content')
    <div class="container" style="opacity: 90%;">
        <div class="offset-1 col-10 card" style="padding: 10px 20px">
          <h2 style="padding-top: 40px; padding-bottom: 40px; text-transform: uppercase">Tous mes rapports</h2>
          <div class="row">
            <div class="col-3">
                <a href="{{ route('ajout_rapport') }}" class="btn btn-primary" style="padding: 10px">
