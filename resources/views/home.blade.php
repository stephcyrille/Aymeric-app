...
@section('customCSS')
  <link href="{{ asset('build/calendar/css/chunk.css') }}" rel="stylesheet"/>
  <link href="{{ asset('build/calendar/css/main.css') }}" rel="stylesheet"/>
@endsection
...
@section('customJS')
  ...
  <script src="{{ asset('build/calendar/js//chunk.js') }}"></script>
  <script src="{{ asset('build/calendar/js//main.js') }}"></script>
